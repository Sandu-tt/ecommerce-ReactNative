      ...
      {total === 0 ? (
       ...
       >
         ...
         <Image
           ...
           source={{
             uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNd3p3dOCQpUW4BNQjUpxXQ9vVMn1B5TDcow&s",
           }}
         />
       </Pressable>
      ) : (
        ...
        >
          ...
          <View style={{ marginLeft: 10 }}>
            <Text style={{ fontWeight: "bold", fontSize: 15 }}>Rs.{total}</Text>
            <Text
              style={{ fontSize: 16, width: 200, marginTop: 3, color: "gray" }}
            >
              Pay Via Cash
